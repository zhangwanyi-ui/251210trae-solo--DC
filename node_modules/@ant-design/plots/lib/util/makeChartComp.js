...
function makeChartComp(chartType) {
    ...
    return (0, react_1.forwardRef)(function (props, ref) {
        ...
        var configKey = (0, react_1.useMemo)(function () { return chartType.charAt(0).toLowerCase() + chartType.slice(1); }, [chartType]);
        ...
        return react_1.default.createElement(base_1.BaseChart, __assign({}, mergedConfig, flowProps, { chartType: chartType, ref: ref }));
    });
}
